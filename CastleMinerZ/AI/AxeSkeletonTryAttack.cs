...
namespace DNA.CastleMinerZ.AI
{
	public class AxeSkeletonTryAttack : BaseTryAttack
	{
		...
		private float[][] _hitTimes = new float[][]
		{
			...
			new float[] { 0.9333f },
			new float[] { 1.5667f },
			new float[] { 0.2667f, 0.5667f, 0.933f, 1.2667f },
			new float[] { 0.3333f, 0.6667f, 1.033f, 1.3667f },
			new float[] { 0.2667f, 0.5667f, 0.933f, 1.2667f },
			new float[] { 0.3333f, 0.6667f, 1.033f, 1.3667f }
		};

		private float[] _hitDamages = new float[]
		{
