	...
	public class ChainsawInventoryItemClass : ModelInventoryItemClass
	{
		...
		public override Entity CreateEntity(ItemUse use, bool attachedToLocalPlayer)
		{
			...
			case ItemUse.UI:
			{
				...
				Matrix matrix = Matrix.Transform(Matrix.CreateScale(28.8f / castleMinerToolModel.GetLocalBoundingSphere().Radius), quaternion);
				Vector3 vector = new Vector3(10f, -20f, 0f);
