...
namespace DNA.CastleMinerZ.Inventory
{
	public class InventoryItem
	{
		...
		public static void Initalize(ContentManager content)
		{
			...
			InventoryItem.RegisterItemClass(new BlockInventoryItemClass(InventoryItemIDs.TNT, BlockTypeEnum.TNT, Strings.Used_to_blow_up_large_areas + ". " + Strings.This_is_a_raw_material_that_must_be_found, 0.01f));
			InventoryItem.RegisterItemClass(new BlockInventoryItemClass(InventoryItemIDs.Ice, BlockTypeEnum.Ice, Strings.Found_on_the_surface + ". " + Strings.Only_destroys_certain_materials, 0.1f));
